...
$q="INSERT INTO `post`(`user_id`, `domaine`, `filiere`, `title`, `description`, `file`) VALUES ('$user_id','$domaine','$filiere','$title','$description','$file_name')";
$r=mysqli_query($dbc,$q);

if ($r) {
    $msg="Le processus d'ajout d'un sujet a réussi";
}else{
                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" action="add_post.php" method="post" enctype="multipart/form-data">
